...
func (c *container) controlsMap() map[string]report.NodeControlData {
	...
	return map[string]report.NodeControlData{
		UnpauseContainer: report.NodeControlData{Dead: !paused},
		RestartContainer: report.NodeControlData{Dead: !running},
		StopContainer:    report.NodeControlData{Dead: !running},
		PauseContainer:   report.NodeControlData{Dead: !running},
		AttachContainer:  report.NodeControlData{Dead: !running},
		ExecContainer:    report.NodeControlData{Dead: !running},
		StartContainer:   report.NodeControlData{Dead: !stopped},
		RemoveContainer:  report.NodeControlData{Dead: !stopped},
	}
}
